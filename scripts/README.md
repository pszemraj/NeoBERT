...
- `evaluation/` — GLUE, MTEB, and analysis utilities. See [/docs/evaluation.md](/docs/evaluation.md) plus [`scripts/evaluation/README.md`](/scripts/evaluation/README.md).
...
- `export-hf/` — Convert checkpoints to Hugging Face format and validate exports. See [/docs/export.md](/docs/export.md) and [`scripts/export-hf/README.md`](/scripts/export-hf/README.md).

## Shared Conventions

- Every Python entry point accepts a `--config` path and dot-notation overrides. The hierarchy and validation rules are documented in [/docs/configuration.md](/docs/configuration.md).
