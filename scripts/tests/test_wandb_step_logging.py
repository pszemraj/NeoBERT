...
def test_metrics_log_with_step():
    ...
    assert call_args.kwargs["step"] == 10, f"Expected step=10, got step={call_args.kwargs['step']}"
    ...
    print("✓ Test passed: metrics.log correctly passes step parameter to accelerator.log")
